...
**Student Name:** Suber Ebrahim
**Student ID:** 827 410 383
...
_If given more time I would've given more time to this assigment, I would've also try to make sense of what category the algortihms belong to instead of trying to make blind sense of their logic.
 I wouuld also work on dev logs at the same time as readME and code._
...
|---|---|
| Part 1: Problem Analysis | 4 hours |
| Part 2: Precomputation Design | 4 hours |
| Part 3: Algorithm Correctness | 6 hours |
| Part 4: Search Design | 3 hours |
| Part 5: State and Search Space | 2 hours |
| Part 6: Pruning | 2 hour|
| Part 7: Implementation | 3 hour |
| README and DEVLOG writing | 4 hours|
| **Total** | about 30 hours|
